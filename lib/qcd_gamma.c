...
/*
 *
 *    gamma_4=-gamma_0 常用的是gamma4
 *
 */
const qcd_complex_16 qcd_GAMMA[8][4][4]=   //手征表象 欧式时空
  {
    {
      { {.re=0.0,.im=0.0},{.re=0.0,.im=0.0},{.re=-1.0,.im=0.0},{.re=0.0,.im=0.0} },
      { {.re=0.0,.im=0.0},{.re=0.0,.im=0.0},{.re=0.0,.im=0.0},{.re=-1.0,.im=0.0} },
...
const qcd_complex_16 qcd_CGAMMA[6][4][4]= //共轭 C=gamma4 gamma2 欧式
  {
    {
      { {.re=0.0,.im=0.0},{.re=0.0,.im=0.0},{.re=0.0,.im=0.0},{.re=-1.0,.im=0.0} },
      { {.re=0.0,.im=0.0},{.re=0.0,.im=0.0},{.re=1.0,.im=0.0},{.re=0.0,.im=0.0} },
...
const qcd_complex_16 qcd_uCGAMMAd[6][4][4] = //1/2 (one+I gamma5) C gamma (one-I gamma5)
{
  {
	{ {.re = 0.0,.im = 0.0},{.re = 0.0,.im = 0.0},{.re = 0.0,.im = 0.0},{.re = 0.0,.im = -1.0} },
	{ {.re = 0.0,.im = 0.0},{.re = 0.0,.im = 0.0},{.re = 0.0,.im = 1.0},{.re = 0.0,.im = 0.0} },
...
const qcd_complex_16 qcd_uBAR_CGAMMAd[6][4][4] =  //1/2 (one+I gamma5) bar(C gamma) (one-I gamma5)
{
  {
	{ {.re = 0.0,.im = 0.0},{.re = 0.0,.im = 0.0},{.re = 0.0,.im = 0.0},{.re = 0.0,.im = 1.0} },
	{ {.re = 0.0,.im = 0.0},{.re = 0.0,.im = 0.0},{.re = 0.0,.im = -1.0},{.re = 0.0,.im = 0.0} },
